...
<li>
<a href="/SAZO/market/views/destination.do" onclick="">배송지 관리</a>
</li>
<li>
<a href="#">개인 정보 수정</a>
</li>
...
<div id="orderlist">
	...
	<c:forEach var="dto" items="${orderlist }">
		<dl>
			...
			<dd style="width: 250px" class="itemNum" style="float: left;">주문번호 : ${dto.orderNum } <br>상품명 : ${dto.itemName }</dd>
			<dd><img class="order_img" alt="" src="${imagePath }${dto.itemNum }/${dto.thumFile}" width="180" height="180"/></dd>
			<dd class="amount">구매 수량 : ${dto.amount }<br><br>
			합계 금액 : ${dto.price }원 <br>
			배송 상태 : ${dto.orderState }</dd>
...
<script src="/common_js/common_filter.js?ver=1.66.0"></script>
<script src="/common_js/orderlist_v1.js?ver=1.66.0"></script>
</div>
</div>
<footer>
                    <hr class=hr2>
