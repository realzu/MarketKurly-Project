...
<a href="/SAZO/market/login.do"><span class="bhs_button">로그인페이지로 이동</span></a>
</p>
</div>
</div>
...
<script>
  function handleEventButtonText() {
    ...
    if(isPayBackEventTime(serverTime))
      document.getElementById('eventButton').textContent ='abd';
    else
      document.getElementById('eventButton').textContent ='abcdefg';
  }
