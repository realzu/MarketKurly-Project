...
<ul class="list_menu">
<li>
<a href="/SAZO/market/views/mypage.do">주문 내역</a>
</li>
...
<h2 class="tit">배송지 관리 <span id="addrListInfo" class="tit_sub">배송지에 따라 상품정보 및 배송유형이 달라질 수 있습니다.</span></h2>
<div class="new_address">
</div>
</div>
<span class="destination_add screen_out"></span>
<div id="tblParent" class="">
...
<script src="/appProxy/appData.php?ver=1.66.0"></script>
<script src="/asset/js/myp/destination/list.bundle.js?ver=1.66.0"></script>
<script>
  window.addEventListener("DOMContentLoaded", function() {
    window._libAddr.fetchAddrList('pc', true);
  });
</script>
</div>
</div>
