...
<title>마켓컬리 :: 카테고리 상품리스트</title>
<link rel="stylesheet" href="../css/real_main.css">
...
<header>
				...
				<ul class="main1">
					<li><a href="#"><b><img
						...
						<ul class="main2">
							...
							<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;과일·견과·쌀
									<ul class="main3">
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;친환경</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;제철과일</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;국산과일</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;수입과일</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;간편과일</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;냉동·건과일</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;견과류</a></li>
										<li><a href="/SAZO/market/list_cate.do?category=fruit">&ensp;&ensp;쌀·잡곡</a></li>
									</ul>
							</a></li>
	...
	<br/><br/>
                <div class="banner1">
                    <a href="#"><img src="../image/%EB%A7%88%EC%BC%93%EC%BB%AC%EB%A6%AC%20%ED%95%98%EB%8B%A8%20%EB%B0%B0%EB%84%88.jpg"></a>
                </div>
                <footer>
                    <hr class=hr2>
