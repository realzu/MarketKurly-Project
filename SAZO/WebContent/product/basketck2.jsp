...
<%@page import="com.items.BasketDTO"%>
...
/* function selectAll(selectAll)  {
	...
	function deleteSelect(){
		...
		f.action="/SAZO/market/basketclear.do";
		f.submit();
		}
	...
	function deleteAll(){
		...
		if(confirm("장바구니를 비우시겠습니까?")) {
		f.action="/SAZO/market/deleteall.do";
		f.submit();
		}
...
<div id="basketlist">
	...
	<dl>
		...
		<dd style="width: 250px" class="itemNum" style="float: left;">상품번호 : ${dto.itemNum } <br>상품명 : ${dto.itemName }</dd>
		...
		구매 수량 : ${dto.amount } <br>
		합계 금액 : ${dto.price }원</dd>
		<dd><a href="#" onclick="deleteSelect();">삭제</a></dd>
		</dl>
