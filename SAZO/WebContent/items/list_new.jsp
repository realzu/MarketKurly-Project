...
<body>
	<div class="container">
				...
				<li><a href="#"><b><img
					...
					<ul class="main2">
						...
						<li><a href="/SAZO/market/list_cate.do?category=meat">&ensp;&ensp;정육·계란
								<ul class="main3">
									<li><a href="/SAZO/market/list_cate.do?category=meat">&ensp;&ensp;국내산
											소고기</a></li>
									<li><a href="/SAZO/market/list_cate.do?category=meat">&ensp;&ensp;수입산
											소고기</a></li>
		...
		<div id="itemList">
			...
			<div>
				<img src="../image/cate_new.png" alt="카테고리배너" class="banner" />
			</div>

			<br />
			<br />

			<div class="listName">신상품</div>

			<br />

			<div id="itemList_info">
				<div class="leftInfo">총 ${dataCount }개</div>
				<div class="rightInfo">
					<ul>
						<li><a href="<%=cp %>/market/list_new.do?num=1">인기순</a> ｜</li>
						<li><a href="<%=cp %>/market/list_new.do?num=2">신상품순</a> ｜</li>
						<li><a href="<%=cp %>/market/list_new.do?num=3">낮은 가격순</a> ｜
						</li>
						<li><a href="<%=cp %>/market/list_new.do?num=4">높은 가격순</a></li>
					</ul>
				</div>
			</div>
			...
			<div id="itemImg">
				...
				%>
					...
					<% if(num==1){ %>
					<c:forEach var="dto" items="${lists_h }">
					...
					%>
						...
						<td>
							<div>
								<a href="<%=cp%>/market/product.do?itemNum=${dto.itemNum}">
									<img alt="${dto.itemName }"
									src="${imagePath }${dto.itemNum }/${dto.thumFile}" class="img" />
								</a>
							</div> <br />
							<div class="imgInfo">
								<a class="imgInfo"
									href="<%=cp%>/market/product.do?itemNum=${dto.itemNum}"> <span
									class="block1">${dto.itemName }</span> <span class="block2">${dto.price }원</span>
