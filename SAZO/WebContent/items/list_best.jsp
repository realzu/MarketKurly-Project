...
<div class="container">
	...
	<div id="itemList"><%--페이지전체 --%>		
		...
		<div id="itemList_info" >
			...
			<div class="rightInfo">						
					<ul>
					<li><a href="<%=cp %>/market/list_best.do?num=1" >인기순</a> ｜ </li>
					<li><a href="<%=cp %>/market/list_best.do?num=2" >신상품순</a> ｜ </li>
					<li><a href="<%=cp %>/market/list_best.do?num=3" >낮은 가격순</a> ｜ </li>
					<li><a href="<%=cp %>/market/list_best.do?num=4" >높은 가격순</a></li>
					</ul>
			</div>
		</div>
